...
const restaurant = {
    ...
    order: function (starterIndex, mainIndex) { // hàm này trả về một mảng gồm 2 phần tử là starter và main
...
console.log(restaurant.order(2, 0)); // Out put: ["Garlic Bread", "Pizza"]
...
let num_1 = 111;
let num_2 = 999;
const obj = { num_1: 23, num_2: 7, num_3: 14 }; // Tạo ra một object có 3 property là num_1, num_2, num_3
({ num_1, num_2 } = obj); // Cú pháp này sẽ gán giá trị của num_1 và num_2 trong object cho num_1 và num_2 được tạo ra ở trên
console.log(num_1, num_2); // => Out put: 23 7
